# Another Engine
Petit moteur C++ / OpenGL 4.3 open-source, encore très tôt dans son développement (early stage). L’objectif est d’explorer un pipeline de rendu moderne et une architecture scène / composants.
